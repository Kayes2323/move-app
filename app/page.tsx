    ...
    <main className="min-h-screen bg-[#080808] text-[#F5F5F0] flex flex-col">
      ...
      <section className="flex-1 flex flex-col justify-center items-center text-center px-6 pt-24 pb-8">
        ...
        <div className="flex items-center gap-2 mb-8">
          <div className="w-2 h-2 rounded-full bg-[#C6F135] shadow-[0_0_8px_#C6F135] animate-pulse"></div>
          <span className="font-mono text-[10px] tracking-[4px] uppercase text-[#C6F135]">
            Bangladesh's First Virtual Run App
          </span>
        </div>

        {/* Title */}
        <h1 className="text-[120px] leading-none font-black tracking-tight text-[#F5F5F0] mb-2"
        ...
        <button
          ...
          className="relative bg-[#C6F135] text-black font-black text-lg tracking-wider uppercase px-10 py-5 hover:bg-white hover:shadow-[0_0_40px_rgba(198,241,53,0.5)] transition-all duration-300 active:scale-95"
        ...
        <div className="flex gap-2 mt-6">
          <div className="w-2 h-2 rounded-full bg-[#C6F135] animate-bounce" style={{ animationDelay: "0ms" }}></div>
        ...
        <div className="border border-white/10 bg-[#181818] p-5 max-w-md mx-auto">
          ...
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <p className="font-black text-lg">Dhaka → Cox's Bazar</p>
            </div>
          ...
          <div className="relative h-1 bg-white/10 mb-8">
            <div className="absolute left-0 top-0 bottom-0 w-[59%] bg-gradient-to-r from-[#C6F135] to-[#FF5C1A] shadow-[0_0_10px_rgba(198,241,53,0.5)]"></div>
            {/* Pin */}
            <div className="absolute top-[-24px]" style={{ left: "59%", transform: "translateX(-50%)" }}>
              <div className="bg-[#C6F135] text-black font-black text-[9px] px-2 py-1 tracking-wider whitespace-nowrap"
                style={{ clipPath: "polygon(0 0, calc(100% - 4px) 0, 100% 4px, 100% 100%, 4px 100%, 0 calc(100% - 4px))" }}>
                📍 Comilla
              </div>
              <div className="w-2 h-2 rounded-full bg-[#C6F135] shadow-[0_0_8px_#C6F135] mx-auto mt-1"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 border border-white/10">
            <div className="p-3 border-r border-white/10 text-center">
              <p className="font-black text-2xl text-white" style={{ fontFamily: "Impact, sans-serif" }}>4.5<span className="text-sm text-white/30">km</span></p>
              <p className="font-mono text-[9px] tracking-widest uppercase text-white/30 mt-1">Today</p>
            </div>
            <div className="p-3 border-r border-white/10 text-center">
              <p className="font-black text-2xl text-white" style={{ fontFamily: "Impact, sans-serif" }}>245<span className="text-sm text-white/30">km</span></p>
              <p className="font-mono text-[9px] tracking-widest uppercase text-white/30 mt-1">Total</p>
            </div>
            <div className="p-3 text-center">
              <p className="font-black text-2xl text-[#FF5C1A]" style={{ fontFamily: "Impact, sans-serif" }}>🔥18</p>
              <p className="font-mono text-[9px] tracking-widest uppercase text-white/30 mt-1">Streak</p>
            </div>
          </div>

          {/* Badges */}
          <div className="flex gap-2 mt-3 flex-wrap">
            <span className="font-mono text-[9px] tracking-widest uppercase border border-[#C6F135]/40 text-[#C6F135] px-3 py-1">🏆 Friends #2</span>
            <span className="font-mono text-[9px] tracking-widest uppercase border border-[#FF5C1A]/40 text-[#FF5C1A] px-3 py-1">🔥 18 Day Streak</span>
            <span className="font-mono text-[9px] tracking-widest uppercase border border-white/10 text-white/40 px-3 py-1">🇧🇩 Run The BD</span>
          </div>
        </div>
      </section>
