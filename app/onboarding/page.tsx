  ...
  return (
    <main style={{
      ...
      <div style={{ paddingTop: "80px", marginBottom: "48px" }}>
        ...
        <p style={{ color: "#9CA3AF", fontSize: "11px", letterSpacing: "3px", marginBottom: "12px" }}>STEP 1 OF 1</p>
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
          <input
            ...
            style={{
              ...
              color: "#0F0F0F",
              border: "none",
              borderBottom: `2px solid ${error ? "#EF4444" : weight ? "#4F6EF7" : "#E5E7EB"}`,
              outline: "none",
              padding: "8px 0",
        ...
        {error && (
          <p style={{ color: "#EF4444", fontSize: "12px", fontFamily: "system-ui", marginBottom: "16px" }}>{error}</p>
        )}
        ...
        {/* Privacy note */}
        <div style={{ background: "#F8F9FA", borderRadius: "14px", padding: "14px 16px", marginBottom: "32px", display: "flex", gap: "10px", alignItems: "flex-start" }}>
        ...
        >
          {loading ? "Saving..." : "Let's Start Moving →"}
        </button>
      </div>
    </main>
  );
