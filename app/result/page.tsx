...
function ResultContent() {
  ...
  return (
    <main style={{
      ...
      {/* ✅ BUTTONS — Share goes to /share page directly */}
      <div style={{ display: "flex", gap: "12px" }}>
        <button
          onClick={() => router.push("/share")}
          style={{ flex: 1, padding: "16px", borderRadius: "16px", background: "#0F0F0F", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
